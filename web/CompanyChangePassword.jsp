...
<form name="form1" method="post" action="savecompass.jsp" onsubmit="return check()">
<table width="617" height="150" border="1" align="center" cellpadding="1" bordercolor="#CC99FF">
<tr>
...
<input name="user" type="text" id="user" value="<%=s1%>" size="35"></td>
<td width="175" rowspan="5" bordercolor="#CC6633" bgcolor="#FFFFFF">
<img src="image/pwd.jpg" width="175" height="140"></td>
</tr>
<tr>
