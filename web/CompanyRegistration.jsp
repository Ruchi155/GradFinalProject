...
else if(((document.form1.comcontact.value.length)<7) ||
((document.form1.comcontact.value.length)>11))
{
...
<tr bgcolor="" width=100%>
<td width="33%" bgcolor="#FFFFFF"><div align="left"><font SIZE="2"
COLOR="black" face =arial >Name</font></div></td>
<td width="67%" bgcolor="#FFFFFF"><div align="left">
<input TYPE="text" name="comname" id="comname" size=30 maxlength=30 value=''>
</div></td>
</tr>
<tr bgcolor =#FEF7E9>
...
<input name="comaddress" TYPE="text" id="comaddress" size=30 maxlength=50 value=''>
</div></td>
</tr>
<tr bgcolor =#FEF7E9>
...
<input name="compost" TYPE="text" id="compost" size=30 maxlength=50 value=''>
</div></td>
</tr>
<tr bgcolor =#FEF7E9>
<td bgcolor="#F2DFE2"><div align="left"><font SIZE="2" COLOR="black" face=arial>Criteria</font></div></td>
<td bgcolor="#F2DFE2"><div align="left"><input name="comcriteria" TYPE="text" id="comcriteria" size=30 maxlength=50 value=''>
</div></td>
</tr>
<tr width=100%>
...
<tr width=100%>
<td bgcolor="#E6F0F0"><div align="left"><font SIZE="2"
COLOR="black" face =arial>Password</font></div></td>
<td bgcolor="#E6F0F0"><div align="left">
...
<td bgcolor="#FFFFFF"><div align="left"><input TYPE="text" name="comcontact" id="comcontact" size=10 maxlength=30 value=''>
&nbsp; <font SIZE="2" COLOR="#CC0000" face
=arial>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(STD-No.)</font></div></td>
</tr>
<tr bgcolor =#FEF7E9>
<td bgcolor="#E6F0F0"><div align="left"><font SIZE="2" COLOR="black" face=arial>Cgpa %</font></div></td>
<td bgcolor="#E6F0F0"><div align="left"><input TYPE="text" name="comcutoff" id="comcutoff" size=30 maxlength=30 value=''>
</div></td>
</tr>
<tr>
<td height="51" colspan=2 bgcolor="#F2DFE2" ><div align="center"><br>
<input TYPE="reset" value="Reset">&nbsp;&nbsp;<input TYPE="submit" value="Submit" onclick="return valid()"></div></td>
</tr>
</table>
</form>
</div>
